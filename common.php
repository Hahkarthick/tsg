...
?>
			...
			<!--/down-->
                           ...
                           <div class="menu">
									<ul id="menu" >
										<li><a href="index.html"><i class="fa fa-tachometer"></i> <span>Smith Recipt Bill Local</span></a></li>
										 <li id="menu-academico" ><a href="#"><i class="fa fa-table"></i> <span>Smith Labour Bill Issue Local</span> <span class="fa fa-angle-right" style="float: right"></span></a>
										 ...
										 <li id="menu-academico" ><a href="#"><i class="fa fa-file-text-o"></i> <span>Smith Labour Bill Issue Other State</span> <span class="fa fa-angle-right" style="float: right"></span></a>
											 <ul id="menu-academico-sub" >
									...
									<li><a href="typography.html"><i class="lnr lnr-pencil"></i> <span>Sale Bill Local</span></a></li>
